...
La web abre directamente ese vehiculo. El operario escribe su nombre o su codigo, y la app autocompleta el otro campo. El DNI funciona como contraseña: si no coincide con el DNI del Excel, no se puede guardar.
...
- Codigo, nombre y DNI firma son obligatorios antes de guardar.
...
2. Escribe el nombre del operario y comprueba que se autocompleta el codigo.
